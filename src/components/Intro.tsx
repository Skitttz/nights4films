...
const Intro = () => {
  return (
    <>
      ...
      <div className="max-w-7xl lg:max-w-5xl mx-auto mt-6 pb-[7rem] cardMD:pb-[2rem] tm:pb-[6rem] animate-fadeIn lg:mb-10 overflow-x-hidden">
        <div className="px-4 sm:px-6 tm:px-4 grid grid-cols-1 desktop:grid-cols-[1fr,350px] cardMD:p-3 gap-x-10 justify-center mx-auto relative">
