...
const Intro = () => {
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto mt-6 pb-[7rem] cardMD:pb-[17rem] tm:pb-[21rem] lg:pb-[24rem] animate-fadeIn lg:mb-10">
        <div className="ml-8 grid grid-cols-[1fr,350px] cardMD:grid-cols-1 cardMD:p-3 gap-x-10 justify-center mx-auto relative">
          <div className="text-slate-400 font-serif">
            ...
            <span className="inline-block text-md w-[390px] cardMD:w-[auto] cardMD:text-xs text-slate-300 font-roboto">
