...
const ReviewFeedByFilm = ({ tokenUser, FilmId }) => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div>
        {data && reviews && reviews.data.length !== 0 ? (
              ...
              >
                <div className="mr-4 ">
                  ...
                  review.attributes.user.data.attributes.avatar.data !==
                    null ? (
                    <img
                      className="w-[60px] rounded-full box-shadow: rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset;"
                      src={
                        review.attributes.user.data.attributes.avatar.data
                          .attributes.url
                      }
